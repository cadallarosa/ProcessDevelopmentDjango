            ...
            for idx, molecule_id in enumerate(molecules, 1):
                ...
                try:
                    ...
                    card = process_molecule(
                        ...
                        show_drop_lines='drop_lines' in (peak_options or []),
...
def process_molecule(molecule_id, mol_df, batch_data, channels, show_shading, show_drop_lines=False, show_trend=True,
