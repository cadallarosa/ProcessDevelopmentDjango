# cld_dashboard/samples/layouts/sample_sets.py - COMPLETE IMPLEMENTATION WITH EMBEDDED APPS
...
def create_sample_set_card(sample_set, analysis_status):
    """Create a card for a single sample set - with EMBEDDED SEC and AKTA support"""
    ...
    if sec_reports.exists():
        ...
        sec_href = f"#!/analysis/sec/report?report_id={latest_report.report_id}"
        sec_button_text = "SEC"
        sec_button_color = "success"
        sec_target = None  # Stay in dashboard
    else:
        # Link to embedded SEC app without specific report
        sec_href = "#!/analysis/sec/report"
        sec_button_text = "SEC"
    ...
    # Create dashboard URL for embedded AKTA
    akta_href = f"#!/analysis/akta/report?fb={','.join(clean_fb_numbers)}"
    akta_button_text = "AKTA"
    ...
    return dbc.Card([
        dbc.CardBody([
            dbc.Row([
                ...
                dbc.Col([
                    html.Div([
                        ...
                        html.P([
                            ...
                            html.Span(" | ", className="text-muted") if sample_set.development_stage else "",
                            f"Stage: {sample_set.development_stage}" if sample_set.development_stage else ""
                ...
                # Right section: Actions with embedded buttons
                dbc.Col([
                    html.Div([
                        dbc.Badge([
